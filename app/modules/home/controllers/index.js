module.exports = (req, res) => {
     ...
     */
    db.query('SELECT * FROM postcategory', function (err, results, fields) {
        /**
    ...
    function render(postcategory) {
        res.render('home/views/index', { postcategory: postcategory , reqQuery: req.query});
    }
}